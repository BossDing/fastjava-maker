...
public class QuartzHelperHtml {
    ...
    public String html() {
        ...
        sb.append(newLine).append("<div class=\"infoPage\">")
                ...
                .append(newLine).append("		<textarea readonly=\"readonly\" class=\"margin\" style=\"margin-top:0px;height:250px\">")
                .append(newLine).append("quartz:")
                .append(newLine).append("  start-delayed: 10 #延时启动，单位秒")
                .append(newLine).append("  log-enabled: true #启动日志")
                .append(newLine).append("  jobs:")
                .append(newLine).append("    - jobClass: com.website.quartz.testJob #定时任务实现类")
                .append(newLine).append("      name: XXX #定时任务实现类")
                .append(newLine).append("      group: XX #任务名称")
                .append(newLine).append("      status: 0 #0未启用 1启用")
                .append(newLine).append("      cron: XXX #调度时间 cron表达式")
                .append(newLine).append("      log: true #开启日志")
