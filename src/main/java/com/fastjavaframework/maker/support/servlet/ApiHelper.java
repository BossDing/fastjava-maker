...
import com.fastjavaframework.maker.support.html.ApiHelperTemplateHtml;
...
public class ApiHelper {
	...
	public Map<String, String> createDoc(String controllerInfo, String publicUrl) {
		...
		for (int classIndex = 0; classIndex < controllers.length; classIndex++) {
			...
			//java文件全部代码
			String oldCode = FileUtil.readFile(controller, "UTF8");
			//java文件class类代码 不包含import
			String javaCode = oldCode;
