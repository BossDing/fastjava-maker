...
import com.fastjavaframework.maker.support.util.SqlMapperBean;
import com.fastjavaframework.maker.support.util.XmlDom;
...
public class CacheHelper {
	 ...
	 * @return
	 */
	public Map<String,String> cacheInfo(String mapperPath, ApplicationContext ctx) {
		Map<String,String> replaceMap = new HashMap<>();
